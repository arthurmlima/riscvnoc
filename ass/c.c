...
uint32_t read_message_pixelValue;
uint8_t  read_message_xDest;
uint8_t  read_message_yDest;
uint8_t  read_message_step;
uint8_t  read_message_frame;
uint8_t  read_message_xOrig;
uint8_t  read_message_yOrig;
uint8_t  read_message_fb;


uint32_t write_message_pixelValue;
uint8_t  write_message_xDest;
uint8_t  write_message_yDest;
uint8_t  write_message_step;
uint8_t  write_message_frame;
uint8_t  write_message_xOrig;
uint8_t  write_message_yOrig;
uint8_t  write_message_fb;
...
void readPixel(void)
{
	...
	read_message_pixelValue= aux>>52;
}
void readXdest(void)
{
	uint64_t aux= PE_READ_ADDRESS & PE_WRITE_ADDRESS_MASK_XDEST;
	read_message_xDest=	aux>>44;
}
void readYdest(void)
{
   read_message_yDest= ((PE_READ_ADDRESS) & (PE_WRITE_ADDRESS_MASK_YDEST))>>36;
}
void readStep(void)
{
	 read_message_step= ((PE_READ_ADDRESS) & (PE_WRITE_ADDRESS_MASK_STEP))>>28;
}
void readFrame(void)
{
	read_message_frame=((PE_READ_ADDRESS) & (PE_WRITE_ADDRESS_MASK_FRAME))>>20;
}
void readXorig(void)
{
	 read_message_xOrig= ((PE_READ_ADDRESS) & (PE_WRITE_ADDRESS_MASK_XORIG))>>12;
}
void readYorig(void)
{
	read_message_yOrig =((PE_READ_ADDRESS) & (PE_WRITE_ADDRESS_MASK_YORIG))>>4;
}
void readFb(void)
{
	read_message_fb=((PE_READ_ADDRESS) & (PE_WRITE_ADDRESS_MASK_FB))>>3;
}
