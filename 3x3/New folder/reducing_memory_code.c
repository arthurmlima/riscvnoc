...
/**/
#define X_TILESi                     (*(volatile uint32_t*)0x00006424)
#define Y_TILESi                     (*(volatile uint32_t*)0x00006420)
#define X_LOCALi                     (*(volatile uint32_t*)0x0000641C)
#define Y_LOCALi                     (*(volatile uint32_t*)0x00006418)
#define SUB_IMAG_WIDTHi              (*(volatile uint32_t*)0x00006414)
#define SUB_IMAG_HEIGHTi             (*(volatile uint32_t*)0x00006410)
#define X_INITi                      (*(volatile uint32_t*)0x0000640C)
#define Y_INITi                      (*(volatile uint32_t*)0x00006408)
#define IMAGE_WIDTHi                 (*(volatile uint32_t*)0x00006404)
#define IMAGE_HEIGHTi                (*(volatile uint32_t*)0x00006400)
